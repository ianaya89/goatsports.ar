...
import { ExternalLink, GraduationCap, Trophy, Target, CheckCircle2, ArrowRight, Mail } from "lucide-react"
...
export default function PartnershipsSection() {
  return (
    <section
      ...
      id="becas-usa"
    >
      {/* Main section with deep navy background */}
      <div
      ...
      >
        {/* American flag decoration - left side */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center mb-12">
            <p className="text-xl tablet:text-2xl desktop:text-3xl font-bold text-white uppercase tracking-wide">
              Convierten tu sueño en tu futuro.
            </p>
          </div>

          {/* Alliance description card */}
          <div className="max-w-4xl mx-auto mb-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 tablet:p-10 border border-white/20">
              <h3 className="text-2xl tablet:text-3xl font-bold text-white mb-6 text-center">
                Una alianza para cumplir tu sueño americano
              </h3>
              ...
              <div className="grid grid-cols-1 tablet:grid-cols-2 gap-4 mb-8">
                ...
                <div className="flex items-start gap-3 bg-white/5 rounded-xl p-4">
                  <CheckCircle2 className="w-6 h-6 text-green-400 flex-shrink-0 mt-0.5" />
                  <div>
                    <h4 className="font-semibold text-white mb-1">Competición de alto nivel</h4>
                    <p className="text-white/70 text-sm">Jugá en ligas universitarias NCAA mientras te formás</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 bg-white/5 rounded-xl p-4">
                  <CheckCircle2 className="w-6 h-6 text-green-400 flex-shrink-0 mt-0.5" />
                  <div>
                    <h4 className="font-semibold text-white mb-1">Acompañamiento integral</h4>
                    <p className="text-white/70 text-sm">Te guiamos desde la postulación hasta tu llegada a USA</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 bg-white/5 rounded-xl p-4">
                  <CheckCircle2 className="w-6 h-6 text-green-400 flex-shrink-0 mt-0.5" />
                  <div>
                    <h4 className="font-semibold text-white mb-1">Red de contactos</h4>
                    <p className="text-white/70 text-sm">Conectate con coaches y universidades de todo Estados Unidos</p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-3 gap-4 tablet:gap-8 max-w-3xl mx-auto mb-8">
            <div className="text-center">
              ...
              <div className="text-white/60 text-sm tablet:text-base">Atletas becados</div>
            </div>
            <div className="text-center border-x border-white/20">
              <div className="text-3xl tablet:text-5xl font-black text-white mb-1">50+</div>
              <div className="text-white/60 text-sm tablet:text-base">Universidades</div>
            </div>
            <div className="text-center">
              <div className="text-3xl tablet:text-5xl font-black text-white mb-1">100%</div>
              <div className="text-white/60 text-sm tablet:text-base">Proceso guiado</div>
            </div>
          </div>
        </div>
      </div>
